...
## Stucco list of data sources (all links were live on Jan 2023)

Source reviewed: https://stucco.github.io/data/ -> we only reviewed the categories for 'articles' and 'vulnerabilities'

### HTML Sourcecode

https://security.blogoverflow.com/feed/
...
https://www.forbes.com/sites/firewall/feed/

http://feeds.feedburner.com/JeremiahGrossman
...
### Urls to files with textual data (e.g., reports, articles)

http://cce.mitre.org/cce/ (xls,xlsx,pdf)

The combined cce file is also available in this 
[repository] (https://github.com/bee3202/cybersecurity-data-sources/blob/main/cce-COMBINED-5.20130214.xls

http://cpe.mitre.org/cpe/) (xls,xlsx,pdf)

https://www.farsightsecurity.com/technical/ (pdf)

https://www.trendmicro.com/en_us/business.html (html)
...
https://archive.f-secure.com/weblog/weblog.rss
...
https://www.sophos.com/en-us/rss/threats/latest-applications.xml
